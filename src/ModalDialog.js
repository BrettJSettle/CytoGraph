...
export default class ModalDialog extends React.Component{
  ...
  render(){
    ...
    if(this.props.className){
      ...
      modalStyle = Object.assign({}, this.props.style)
    ...
    return (
      <div {..._filteredProps(this.props)} className='modal-wrapper' style={modalStyle} onClick={this.hideOnOuterClick} data-modal="true">
        <div className={(this.props.containerClassName ? this.props.containerClassName : "") + " container modal-dialog"} style={containerStyle}>
          {this.props.children}
        </div>
      </div>
    )
